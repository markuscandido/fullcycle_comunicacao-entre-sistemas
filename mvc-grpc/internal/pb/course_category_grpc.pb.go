...
type CategoryServiceClient interface {
	...
	CreateCategoryStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[CreateCategoryStreamRequest, CreateCategoryStreamResponse], error)
	CreateCategoryStreamBidirectional(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[CreateCategoryStreamBidirectionalRequest, CreateCategoryStreamBidirectionalResponse], error)
...
func (c *categoryServiceClient) CreateCategoryStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[CreateCategoryStreamRequest, CreateCategoryStreamResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[CreateCategoryStreamRequest, CreateCategoryStreamResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_CreateCategoryStreamClient = grpc.ClientStreamingClient[CreateCategoryStreamRequest, CreateCategoryStreamResponse]

func (c *categoryServiceClient) CreateCategoryStreamBidirectional(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[CreateCategoryStreamBidirectionalRequest, CreateCategoryStreamBidirectionalResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[CreateCategoryStreamBidirectionalRequest, CreateCategoryStreamBidirectionalResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_CreateCategoryStreamBidirectionalClient = grpc.BidiStreamingClient[CreateCategoryStreamBidirectionalRequest, CreateCategoryStreamBidirectionalResponse]
...
type CategoryServiceServer interface {
	...
	CreateCategoryStream(grpc.ClientStreamingServer[CreateCategoryStreamRequest, CreateCategoryStreamResponse]) error
	CreateCategoryStreamBidirectional(grpc.BidiStreamingServer[CreateCategoryStreamBidirectionalRequest, CreateCategoryStreamBidirectionalResponse]) error
...
func (UnimplementedCategoryServiceServer) CreateCategoryStream(grpc.ClientStreamingServer[CreateCategoryStreamRequest, CreateCategoryStreamResponse]) error {
	return status.Errorf(codes.Unimplemented, "method CreateCategoryStream not implemented")
}
func (UnimplementedCategoryServiceServer) CreateCategoryStreamBidirectional(grpc.BidiStreamingServer[CreateCategoryStreamBidirectionalRequest, CreateCategoryStreamBidirectionalResponse]) error {
...
func _CategoryService_CreateCategoryStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCategoryStream(&grpc.GenericServerStream[CreateCategoryStreamRequest, CreateCategoryStreamResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_CreateCategoryStreamServer = grpc.ClientStreamingServer[CreateCategoryStreamRequest, CreateCategoryStreamResponse]

func _CategoryService_CreateCategoryStreamBidirectional_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCategoryStreamBidirectional(&grpc.GenericServerStream[CreateCategoryStreamBidirectionalRequest, CreateCategoryStreamBidirectionalResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_CreateCategoryStreamBidirectionalServer = grpc.BidiStreamingServer[CreateCategoryStreamBidirectionalRequest, CreateCategoryStreamBidirectionalResponse]
